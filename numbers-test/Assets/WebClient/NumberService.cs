...
public partial class ServizioNumbers : System.Web.Services.Protocols.SoapHttpClientProtocol {
    ...
    /// <remarks/>
    public System.IAsyncResult BegingetUser(string uuid, System.AsyncCallback callback, object asyncState) {
        return this.BeginInvoke("getUser", new object[] {
                    uuid}, callback, asyncState);
    }
    
    /// <remarks/>
    public Users EndgetUser(System.IAsyncResult asyncResult) {
        object[] results = this.EndInvoke(asyncResult);
        return ((Users)(results[0]));
    }
    ...
    /// <remarks/>
    public System.IAsyncResult BeginsetUsers(Users u, System.AsyncCallback callback, object asyncState) {
        return this.BeginInvoke("setUsers", new object[] {
                    u}, callback, asyncState);
    }
    
    /// <remarks/>
    public string EndsetUsers(System.IAsyncResult asyncResult) {
        object[] results = this.EndInvoke(asyncResult);
        return ((string)(results[0]));
    }
    ...
    /// <remarks/>
    public System.IAsyncResult BeginupdUserScore1(int id_user, float score1, System.AsyncCallback callback, object asyncState) {
        return this.BeginInvoke("updUserScore1", new object[] {
                    id_user,
                    score1}, callback, asyncState);
    }
    
    /// <remarks/>
    public void EndupdUserScore1(System.IAsyncResult asyncResult) {
